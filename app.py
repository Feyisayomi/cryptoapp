...
st.title("Crypto:Ethereum Prediction")
st.markdown("This application enables you to predit the future value of ethereum in any number of days.\
 The Ethereum value has been converted to Bitcoin")
